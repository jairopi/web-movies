...
if(isset($_SESSION['user'])) { 
    ...
    $query_date = "SELECT time FROM recs WHERE user_id = ".$id." ORDER BY time DESC LIMIT 1 OFFSET 0";
    ...
    if(time() > $datedb+300) {
        ...
        ## Funcion matlab filtrado(idusuario) ##
        $ruta="/home/alumnos/ai2/matlab\r\n";
        #$fun="updateRec(INSERT INTO recs (user_id, movie_id, rec_score) VALUES (1,1500,5))\r\n";
        $fun="filtrado(".$id.")\r\n";
        #$fun=$id+'\r\n\r\n';
        ...
        ## Envia correctamente el id de usuario y lo procesa el script de Matlab
    ...
    #Obtener peliculas recomendadas
    $query_rec = "SELECT m.* FROM movie AS m INNER JOIN (SELECT movie_id FROM recs WHERE user_id = ".$id." ORDER BY time DESC  LIMIT 8 OFFSET 0) as r ON m.id = r.movie_id";
